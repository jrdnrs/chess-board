...
export class ChessEngine {
    ...
    */
    reset() {
        wasm.chessengine_reset(this.ptr);
    }
    /**
    * @param {string} fen
    */
    load_fen(fen) {
        try {
            ...
            wasm.chessengine_load_fen(retptr, this.ptr, ptr0, len0);
    ...
    */
    get_active_color() {
        const ret = wasm.chessengine_get_active_color(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {boolean}
    */
    is_in_check() {
        const ret = wasm.chessengine_is_in_check(this.ptr);
        return ret !== 0;
    }
    /**
    * @returns {Uint32Array}
    */
    get_legal_moves() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.chessengine_get_legal_moves(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    make_move(legal_move) {
        wasm.chessengine_make_move(this.ptr, legal_move);
    }
}
